...
class RLM_REPL(RLM):
    ...
    def __init__(
        ...
        Args:
            ...
            model: Pydantic AI model string for orchestration (e.g., 'openrouter:openai/gpt-5.3-codex')
            recursive_model: Pydantic AI model string for sub-LLM calls
            recursive_fallback_model: Fallback model for sub-LLM if primary errors
